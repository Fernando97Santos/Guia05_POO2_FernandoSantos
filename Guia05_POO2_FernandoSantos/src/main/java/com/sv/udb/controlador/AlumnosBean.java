...
public class AlumnosBean implements Serializable{
    ...
    public void guar()
    {
        ...
        try
        {
            ...
            this.alumList = this.ConsTodo();
            this.objeAlum = new Alumnos();
            ctx.execute("setMessage('MESS_SUCC', 'Alerta', 'Datos guardados con éxito :D');");
        }
        catch(Exception ex)
        {
    ...
    public void modi()
    {
        ...
        try
        {
            ...
            this.alumList = this.ConsTodo();
            this.objeAlum = new Alumnos();
            ctx.execute("setMessage('MESS_SUCC', 'Alerta', 'Registro modificado con éxito :D');");
        }
        catch(Exception ex)
        {
            tx.rollback();
    ...
    public void elim(int codi)
    {
        ...
        try
        {
            ...
            this.alumList = this.ConsTodo();
            this.objeAlum = new Alumnos();
            ctx.execute("setMessage('MESS_SUCC', 'Alerta', 'Registro eliminado con éxito :D');");
        }
        catch(Exception ex)
        {
            tx.rollback();
